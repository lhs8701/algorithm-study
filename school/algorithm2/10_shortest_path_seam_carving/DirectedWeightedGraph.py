    ...
    def relax(self, e):
        ...
        if self.distTo[e.w] > self.distTo[e.v] + e.weight:
            ...
            if self.pq.contains(e.w):
                ...
                self.pq.insert(e.w, self.distTo[e.w])
...
if __name__ == "__main__":
    ...
    for i in range(g8i.V):
        if sp8i.hasPathTo(i):
            print(i, sp8i.distTo[i], sp8i.pathTo(i))
        else:
            print(i, "no path exists")
    print()
    ...
    for i in range(g8a.V):
        if sp8a.hasPathTo(i):
            print(i, sp8a.distTo[i], sp8a.pathTo(i))
        else:
            print(i, "no path exists")
    print()
    ...
    for i in range(g8bn.V):
        if sp8bn.hasPathTo(i):
            print(i, -sp8bn.distTo[i], sp8bn.pathTo(i))
        else:
            print(i, "no path exists")
    print()
    ...
    for i in range(g6n.V):
        if sp6n.hasPathTo(i):
            print(i, sp6n.distTo[i], sp6n.pathTo(i))
        else:
            print(i, "no path exists")
    print()
    ...
    for i in range(g6n.V):
        if sp6nD.hasPathTo(i):
            print(i, sp6nD.distTo[i], sp6nD.pathTo(i))
        else:
            print(i, "no path exists")
    print()
